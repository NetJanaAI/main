...
export default function Profile() {
  ...
  return (
    <div className="flex flex-col gap-12 animate-fade-in max-w-5xl">
       <header>
          <h1 className="text-3xl font-serif italic text-white tracking-widest uppercase mb-2">Protocol User Profile</h1>
          ...
          <div className="lg:col-span-12 space-y-12">
             <section className="bg-white/5 border border-white/5 p-12 rounded-2xl flex flex-col md:flex-row items-center gap-12 relative overflow-hidden backdrop-blur-3xl">
                ...
                <div className="relative z-10">
                   <UserButton appearance={{ elements: { rootBox: "w-32 h-32 rounded-full border-4 border-[#D4AF37]/20 overflow-hidden shadow-[0_0_40px_rgba(212,175,55,0.1)] p-0 flex items-center justify-center bg-black/40" } }} />
                </div>
                <div className="flex-1 text-center md:text-left relative z-10 lg:pl-4">
                   <h2 className="text-3xl font-bold text-white uppercase tracking-tight mb-2 leading-none font-serif italic italic-strong">
                   ...
                   <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-[10px] uppercase font-black tracking-widest text-white/40 mb-6 border-b border-white/5 pb-6">
                      <span className="bg-[#D4AF37]/10 text-[#D4AF37] px-3 py-1 rounded border border-[#D4AF37]/20">Protocol Alpha</span>
                ...
                <section className="bg-white/5 border border-white/5 p-8 rounded-2xl flex flex-col justify-between backdrop-blur-3xl">
                   <div>
                     <div className="flex items-center gap-2 mb-4">
                        <Key className="w-5 h-5 text-[#D4AF37]" strokeWidth={2.5} />
                     ...
                     <div className="relative group mb-4">
                        <div className="bg-black/80 border border-white/10 rounded-xl py-4 pl-4 pr-32 text-xs font-black font-data text-[#D4AF37] tracking-[2px] truncate group-hover:border-[#D4AF37]/40 transition-colors cursor-text select-all">
             ...
             <section className="bg-red-500/[0.02] border border-red-500/10 p-12 rounded-2xl flex flex-col items-center text-center group hover:bg-red-500/[0.05] transition-all">
                ...
                <h3 className="text-xl font-bold font-serif text-white uppercase italic italic-strong mb-2 tracking-widest">Initialization of 'Vanish' Protocol</h3>
