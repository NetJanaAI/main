    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h3 className="text-xl font-serif italic text-gray-200">
                    {market === 'IN' ? 'India' : 'UAE'} Signal Intelligence
                </h3>
                <span className="text-xs font-black uppercase tracking-widest text-[#D4AF37]/50 flex items-center gap-2">
            ...
            <div className="space-y-4">
                ...
                {filteredLeads.map((lead) => (
                    <div key={lead.lead_id} className="relative p-6 rounded-xl border border-white/10 bg-[#061124] overflow-hidden shadow-2xl">
                        {/* Background Accent */}
                        <div className={`absolute top-0 right-0 w-64 h-64 opacity-20 blur-3xl rounded-full transform translate-x-1/2 -translate-y-1/2 ${lead.verity_tier === 'HIGH_VERITY' ? 'bg-[#D4AF37]' : 'bg-blue-500'}`} />
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row gap-8">
                            ...
                            <div className="w-full md:w-1/3 space-y-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    <span className={`px-2 py-1 text-[10px] font-black uppercase tracking-widest rounded-md border flex items-center gap-1 ${lead.verity_tier === 'HIGH_VERITY' ? 'bg-[#D4AF37]/10 border-[#D4AF37]/30 text-[#D4AF37]' : 'bg-blue-500/10 border-blue-500/30 text-blue-400'
                                        }`}>
                                ...
                                <div className="pt-2">
                                    ...
                                    <div className="flex items-end gap-2">
                                        <span className="text-3xl font-serif italic text-white leading-none">{(lead.intent_score * 100).toFixed(0)}</span>
                            ...
                            <div className="w-full md:w-2/3 flex flex-col gap-4">
                                <div className="bg-black/20 rounded-lg p-4 border border-white/5">
                                    <h5 className="text-[10px] font-black uppercase tracking-widest text-[#D4AF37]/70 mb-2 flex items-center gap-2">
